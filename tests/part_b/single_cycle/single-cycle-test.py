...
tests = [
  ("cpu add/lui/sll test", "cpu-add-lui-sll"),
  ("cpu addi test", "cpu-addi"),
  ("cpu branch+jump test", "cpu-branch-jump"),
  ("cpu branch test", "cpu-branch"),
  ("cpu jump test", "cpu-jump"),
  ("cpu mem test", "cpu-mem"),
]
...
def run_tests(tests):
  print("Running single-cycle CPU tests...")
  tests_passed = 0
  tests_failed = 0
